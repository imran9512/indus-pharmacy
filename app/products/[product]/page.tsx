...
export default async function Product({ params }: ProductSlug) {
  ...
  const structuredData = {
    ...
    sku: product.sku, // Ensure this is available in your product data
    offers: {
      "@type": "Offer",
    ...
    image: product.images[0], // First image as representative
  };
              ...
              <div className="space-y-6">
                ...
                {product.ingredients && (
                  <div className="flex flex-col gap-1">
                    <p className="font-semibold text-xs text-zinc-600">Ingredients</p>
                ...
                <div>
                  <p className="font-semibold text-xs text-zinc-600">Active Substance</p>
                  <p className="text-xs text-zinc-600">Temozokomide</p>
                </div>
                <div>
                  <p className="font-semibold text-xs text-zinc-600">Additional Information</p>
                  <p className="text-xs text-zinc-600">{product.additional_info}</p>
                </div>
              </div>
            </div>
