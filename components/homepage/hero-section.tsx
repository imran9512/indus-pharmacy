  ...
  return (
    <section className="h-screen relative flex items-center justify-center px-4">
      ...
      <div className="z-50 max-w-2xl text-center">
        ...
        <p className="text-lg">Welcome to MaleSort is your one-stop shop for addressing a variety of personal health concerns.
            ...
            to help you feel your best. Our comprehensive selection of products caters to both men's and women's needs,
             focusing on overall well-being. Whether you're seeking solutions for common issues like erectile dysfunction ED or
              ...
              support your health journey. We prioritize discretion and privacy. Our platform allows you to browse and purchase
               ...
               empowering individuals to take control of their health. We believe in providing access to informative resources and 
               effective products to help you achieve optimal well-being.
        </p>
      </div>
    </section>
  );
